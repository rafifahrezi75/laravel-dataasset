        ...
        <div class="card-body">
            <form action="{{ route('asset.perbaikanupdate', $perbaikan->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div hidden class="form-group">
                    ...
                    <input type="text" class="form-control @error('idasset') is-invalid @enderror" name="idasset" id="idasset" placeholder="Idasset" autocomplete="off" value="{{ old('idasset') ?? $perbaikan->idasset }}">
                    @error('idasset')
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control @error('keterangan') is-invalid @enderror" name="keterangan" id="keterangan" autocomplete="off" value="">{{ old('keterangan') ?? $perbaikan->keterangan }}</textarea>
                    @error('keterangan')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('harga') is-invalid @enderror" name="harga" id="harga" placeholder="Harga" autocomplete="off" value="{{ old('harga') ?? $perbaikan->harga }}">
                    @error('harga')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <button class="btn btn-default">
                    <a href="" class="btn btn-default">Kembali ke list</a>
                </button>
